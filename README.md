...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6979&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nteract_on_jupyter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nteract_on_jupyter` can be installed with:

```
conda install nteract_on_jupyter
```

It is possible to list all of the versions of `nteract_on_jupyter` available on your platform with:
